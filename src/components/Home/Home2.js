        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              something, I think… 🤷‍♂️
              <br />
              <br />I have core understanding on programming Languages like
              <i>
                <b className="purple">Java, Javascript, C# and Python</b>
              </i>
              <br />
              <br />
              My field of Interest's is to build new &nbsp;
              <i>
              ...
              &nbsp; like
              <i>
                <b className="purple"> React.js, Next.js, Angular and Flutter.</b>
              </i>
            </p>
          </Col>
